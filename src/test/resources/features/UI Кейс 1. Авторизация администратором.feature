...
Функция: UI Кейс 1. Авторизация администратором.
  ...
  Сценарий: Авторизация пользователем с правами администратора. Проверка присутствия элементов страницы после авторизации
