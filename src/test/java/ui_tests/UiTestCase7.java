...
public class UiTestCase7 {
    ...
    @Test(description = "Кейс 7. Авторизация пользователя с правами администратора.  Переход на страницы \"Админитрирование\" и \"Пользовтели\". Проверка наличия таблицы пользователей и сортировки пользователей по фамилии и имени")
