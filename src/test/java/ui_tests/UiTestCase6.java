...
public class UiTestCase6 {
    ...
    @Test(description = "Кейс 6. Авторизация пользователя с правами администратора. Переход на страницу \"Админитрирование\" и \"Пользовтели\". Проверка наличия таблицы и сортировки пользователей по логину")
